...
function mod:OnCreated()
	self.knockback_slow_pct = AbilityKV:Get(self:GetAbility(), "knockback_slow_pct")
	if not self.knockback_slow_pct or self.knockback_slow_pct <= 0 then self.knockback_slow_pct = 40 end
end
