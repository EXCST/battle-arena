-- ============================================================
-- BATTLE ARENA — Travaler: втягивание к точке (вакуум)
-- MOTION_HORIZONTAL, скорость из kv, БЕЗ рута (можно выбежать
-- блинком/ускорением/BKB).
-- ============================================================

modifier_travaler_pull = modifier_travaler_pull or class({})

local mod = modifier_travaler_pull
...
function mod:OnCreated(kv)
	...
	self.speed = tonumber(kv.speed) or 900
