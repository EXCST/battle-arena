...
function modifier_item_radiance_effect_lua:GetModifierMissPercentage()
	return self.blind_pct
end

function modifier_item_radiance_effect_lua:GetEffectName()
	return "particles/econ/events/ti9/radiance_ti9.vpcf"
end

function modifier_item_radiance_effect_lua:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end

function modifier_item_radiance_effect_lua:OnIntervalThink()
	if IsServer() then
		local flDamagePerTick = self.damage_tick * self.aura_damage
