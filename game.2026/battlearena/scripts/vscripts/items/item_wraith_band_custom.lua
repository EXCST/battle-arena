item_wraith_band = class({})

function item_wraith_band:GetIntrinsicModifierName()
...
function modifier_item_wraith_band_custom:RecomputeBonus()
	...
	self.bonus_attack_speed = self.ability:GetSpecialValueFor("bonus_attack_speed") * self.multiplier
end

function modifier_item_wraith_band_custom:CheckUpgrade()
...
function modifier_item_wraith_band_custom:OnIntervalThink()
	self:CheckUpgrade()
end
