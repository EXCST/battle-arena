...
function modifier_item_bane_blade_debuff:OnRefresh()
    ...
    self.debuff_dps_stat = self.ability:GetSpecialValueFor("debuff_dps_stat_pct") / 100 * (self:GetCaster():GetStrength(true) + self:GetCaster():GetAgility(true) + self:GetCaster():GetPrimaryStatValue())
