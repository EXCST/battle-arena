...
function item_bracer:GetIntrinsicModifierName()
...
function modifier_item_bracer_custom:RecomputeBonus()
	...
	self.bonus_hp_regen = self.ability:GetSpecialValueFor("bonus_health_regen") * self.multiplier
end

function modifier_item_bracer_custom:CheckUpgrade()
...
function modifier_item_bracer_custom:OnIntervalThink()
	self:CheckUpgrade()
end
