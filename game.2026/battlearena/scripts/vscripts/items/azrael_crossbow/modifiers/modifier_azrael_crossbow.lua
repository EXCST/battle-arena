...
function mod:OnCreated( kv )
	...
	if IsServer() then
		...
		if parent and parent.GetUnitName and parent:GetUnitName() == "npc_hero_huntress" then
			local curse = parent:FindAbilityByName("huntress_curse_arrow")
			if curse then
				curse:SetLevel(1)
