...
function modifier_item_desolator_custom:OnAttackLanded(kv)
	...
	if(kv.target:HasModifier("modifier_item_imba_desolator_2_debuff")) then
		return
	end
	Desolate(self.parent, kv.target, self.ability, "modifier_item_imba_desolator_debuff", self.duration)
end
...
function item_imba_desolator:OnSpellStart()
	if IsServer() then
		...
		local desolator_projectile = {
			Ability				= self,
			EffectName			= "particles/custom/item/desolator/desolator_active.vpcf",
...
function item_imba_desolator:OnProjectileHit(target, target_loc)
	if IsServer() and target then
		...
		local effect_pfx = ParticleManager:CreateParticle("particles/custom/item/desolator/desolator_active_damage.vpcf", PATTACH_CUSTOMORIGIN, target)
...
function modifier_item_imba_desolator:GetModifierProjectileName()
...
function item_imba_desolator_2:OnSpellStart()
	...
	local desolator_projectile = {
		Ability				= self,
		EffectName			= "particles/custom/item/desolator/desolator2_active.vpcf",
...
function modifier_item_imba_desolator_2:GetModifierProjectileName()
	return "particles/items_fx/desolator_projectile.vpcf"
end
...
item_imba_desolator_3 = class(item_imba_desolator_2)
...
LinkLuaModifier("modifier_item_imba_desolator_debuff", "items/item_desolator", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_desolator_debuff)
LinkLuaModifier("modifier_item_imba_desolator_2_debuff", "items/item_desolator", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_desolator_2_debuff)
LinkLuaModifier("modifier_item_imba_desolator", "items/item_desolator", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_desolator)
LinkLuaModifier("modifier_item_imba_desolator_2", "items/item_desolator", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_desolator_2)
LinkLuaModifier("modifier_item_desolator_custom", "items/item_desolator", LUA_MODIFIER_MOTION_NONE, modifier_item_desolator_custom)