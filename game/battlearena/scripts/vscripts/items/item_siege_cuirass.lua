...
LinkLuaModifier("modifier_imba_siege_cuirass", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass)
LinkLuaModifier("modifier_imba_siege_cuirass_aura_positive", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass_aura_positive)
LinkLuaModifier("modifier_imba_siege_cuirass_aura_positive_effect", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass_aura_positive_effect)
LinkLuaModifier("modifier_imba_siege_cuirass_aura_negative", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass_aura_negative)
LinkLuaModifier("modifier_imba_siege_cuirass_aura_negative_effect", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass_aura_negative_effect)
LinkLuaModifier("modifier_imba_siege_cuirass_active", "items/item_siege_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_siege_cuirass_active)
