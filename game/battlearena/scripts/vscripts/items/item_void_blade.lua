...
item_void_blade = class({
    GetIntrinsicModifierName = function()
        return "modifier_item_void_blade"
    end
})

item_void_blade_1 = class(item_void_blade)
item_void_blade_2 = class(item_void_blade)
item_void_blade_3 = class(item_void_blade)

modifier_item_void_blade = class({
	IsHidden  = function() 
        return true 
    end,
    IsPurgable = function()
...
function modifier_item_void_blade:OnCreated( params )
...
function modifier_item_void_blade:OnRefresh()
...
function modifier_item_void_blade:GetModifierPreAttack_BonusDamage()
    return self.bonus_damage
end

function modifier_item_void_blade:GetModifierBonusStats_Agility()
    return self.bonus_agi
end

function modifier_item_void_blade:GetModifierProcAttack_BonusDamage(kv)
...
LinkLuaModifier("modifier_item_void_blade", "items/item_void_blade", LUA_MODIFIER_MOTION_NONE, modifier_item_void_blade)