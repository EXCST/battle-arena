...
function makeParticle(unit)
	local pos = unit:GetAbsOrigin()

	local idx = ParticleManager:CreateParticle("particles/econ/items/silencer/silencer_ti6/silencer_last_word_status_ti6_ring_end.vpcf", PATTACH_ABSORIGIN_FOLLOW, unit)
