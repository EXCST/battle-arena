function Blink(keys)
	...
	for _, target in pairs(units) do
		local particle = ParticleManager:CreateParticle("particles/units/heroes/hero_leshrac/leshrac_lightning_storm_bolt.vpcf", PATTACH_WORLDORIGIN, target)
	...
	caster:EmitSound("HeroLeshrac.LightningStorm")
end
