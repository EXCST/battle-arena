...
function mod:OnCreated( kv )
	...
	if abilityLevel <= 0 then
		abilityLevel = 1
		print("[HEROFALL] WARNING: ability level is <=0, forcing to 1")
	end
	...
	print("[HEROFALL] Debug - ability:", ability)
	print("[HEROFALL] Debug - ability:GetAbilityName():", ability:GetAbilityName())
	print("[HEROFALL] Debug - GetSpecialValueFor height:", ability:GetSpecialValueFor("height"))
	print("[HEROFALL] Debug - GetSpecialValueFor speed:", ability:GetSpecialValueFor("speed"))
	print("[HEROFALL] Debug - GetSpecialValueFor damage:", ability:GetSpecialValueFor("damage"))
	print("[HEROFALL] Debug - GetSpecialValueFor stun_duration:", ability:GetSpecialValueFor("stun_duration"))
	print("[HEROFALL] Debug - GetSpecialValueFor aoe_radius:", ability:GetSpecialValueFor("aoe_radius"))
