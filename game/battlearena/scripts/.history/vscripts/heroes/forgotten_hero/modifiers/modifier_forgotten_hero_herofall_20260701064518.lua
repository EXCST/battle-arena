...
function mod:OnCreated( kv )
	...
	-- Try GetSpecialValueFor first (uses current level automatically)
	...
	-- Fallback to GetLevelSpecialValueFor if GetSpecialValueFor returned 0
	if self.height == 0 or self.speed == 0 then
		print("[HEROFALL] GetSpecialValueFor returned 0, trying GetLevelSpecialValueFor")
		self.height  = ability:GetLevelSpecialValueFor("height", abilityLevel-1) 
		self.speed   = ability:GetLevelSpecialValueFor("speed", abilityLevel-1)
		self.damage  = ability:GetLevelSpecialValueFor("damage", abilityLevel-1)
		self.stunDur = ability:GetLevelSpecialValueFor("stun_duration", abilityLevel-1)
	end
