...
function item_storm_edge:OnSpellStart()
    ...
    self.benis = ParticleManager:CreateParticle(
        "particles/econ/items/sniper/sniper_fall20_immortal/sniper_fall20_immortal_base_attack_projectile_trail.vpcf", 
...
function item_storm_edge:OnProjectileHit(target, pos)
    ...
    ParticleManager:DestroyParticle(self.benis, true)
...
function item_storm_edge:OnProjectileThink(pos) ParticleManager:SetParticleControl(self.benis, 3, pos) end
...
function modifier_item_storm_edge_active:GetTexture() return "item_storm_edge" end
