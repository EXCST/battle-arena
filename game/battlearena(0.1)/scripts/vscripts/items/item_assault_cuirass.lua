...
LinkLuaModifier("modifier_imba_assault_cuirass", "items/item_assault_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_assault_cuirass)
LinkLuaModifier("modifier_imba_assault_cuirass_aura_positive", "items/item_assault_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_assault_cuirass_aura_positive)
LinkLuaModifier("modifier_imba_assault_cuirass_aura_positive_effect", "items/item_assault_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_assault_cuirass_aura_positive_effect)
LinkLuaModifier("modifier_imba_assault_cuirass_aura_negative", "items/item_assault_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_assault_cuirass_aura_negative)
LinkLuaModifier("modifier_imba_assault_cuirass_aura_negative_effect", "items/item_assault_cuirass", LUA_MODIFIER_MOTION_NONE, modifier_imba_assault_cuirass_aura_negative_effect)
