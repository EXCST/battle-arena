...
LinkLuaModifier("modifier_imba_skull_basher", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE, modifier_imba_skull_basher)
LinkLuaModifier("modifier_imba_skull_basher_unique", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE, modifier_imba_skull_basher_unique)
LinkLuaModifier("modifier_imba_skull_basher_bash", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE, modifier_imba_skull_basher_bash)
LinkLuaModifier("modifier_imba_skull_basher_skull_crash", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE, modifier_imba_skull_basher_skull_crash)
LinkLuaModifier("modifier_imba_skull_basher_skull_break", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE, modifier_imba_skull_basher_skull_break)
