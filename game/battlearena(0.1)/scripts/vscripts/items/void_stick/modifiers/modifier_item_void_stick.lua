...
function modifier_item_void_stick:GetModifierExtraManaBonus( params ) return self.bonus_mana end
function modifier_item_void_stick:GetModifierExtraHealthBonus( params ) return self.bonus_hp end
