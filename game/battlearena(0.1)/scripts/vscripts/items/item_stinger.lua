...
function modifier_item_stinger_debuff:OnRefresh()
    ...
    self.debuff_dps_stat = self.ability:GetSpecialValueFor("debuff_dps_stat_pct")/100*(self.caster:GetStrength()+self.caster:GetAgility()+self.caster:GetPrimaryStatValue())
