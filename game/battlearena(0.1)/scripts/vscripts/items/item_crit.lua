...
function modifier_item_imba_lesser_crit_buff:GetCritDamage()
	return self.base_crit / 100
end

item_greater_crit_custom = class(item_imba_lesser_crit)
-----------------------------------------------------------------------------------------------------------
--	Daedalus definition
-----------------------------------------------------------------------------------------------------------
...
function modifier_item_imba_greater_crit_buff:GetModifierPreAttack_CriticalStrike( params )
	if IsServer() then
		...
		local crit_power = self.base_crit + self.crit_increase * stacks
...
function modifier_item_imba_greater_crit_buff:GetCritDamage()
	-- Find how many Daedaluses we have for calculating crits
	local crit_modifiers = self.caster:FindAllModifiersByName("modifier_item_imba_greater_crit")
	-- Get current power
	local stacks = self:GetStackCount()
...
LinkLuaModifier("modifier_item_imba_greater_crit", "items/item_crit", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_greater_crit)
LinkLuaModifier("modifier_item_imba_lesser_crit", "items/item_crit", LUA_MODIFIER_MOTION_NONE, modifier_item_imba_lesser_crit)
LinkLuaModifier("modifier_item_imba_lesser_crit_buff", "items/item_crit", LUA_MODIFIER_MOTION_NONE,  modifier_item_imba_lesser_crit_buff)
LinkLuaModifier("modifier_item_imba_greater_crit_buff", "items/item_crit", LUA_MODIFIER_MOTION_NONE,  modifier_item_imba_greater_crit_buff)
