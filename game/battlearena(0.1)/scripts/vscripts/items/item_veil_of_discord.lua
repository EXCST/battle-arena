...
function modifier_veil_passive:GetAuraSearchFlags()
...
function modifier_veil_passive:OnDestroy()
	if IsServer() and not self:GetParent():HasModifier("modifier_veil_passive") then
...
function modifier_veil_debuff_aura_modifier:OnCreated()
	...
	self.magic_resis    =   self.ability:GetSpecialValueFor("aura_resist")
end
...
function modifier_veil_buff_aura_modifier:OnCreated()
	...
	self.spell_power    =   self.ability:GetSpecialValueFor("aura_spell_power")
end
...
LinkLuaModifier("modifier_veil_passive", "items/item_veil_of_discord", LUA_MODIFIER_MOTION_NONE, modifier_veil_passive)
LinkLuaModifier("modifier_veil_debuff_aura_modifier", "items/item_veil_of_discord", LUA_MODIFIER_MOTION_NONE, modifier_veil_debuff_aura_modifier)
LinkLuaModifier("modifier_veil_buff_aura", "items/item_veil_of_discord", LUA_MODIFIER_MOTION_NONE, modifier_veil_buff_aura)
LinkLuaModifier("modifier_veil_buff_aura_modifier", "items/item_veil_of_discord", LUA_MODIFIER_MOTION_NONE, modifier_veil_buff_aura_modifier)
LinkLuaModifier("modifier_veil_active_debuff", "items/item_veil_of_discord", LUA_MODIFIER_MOTION_NONE, modifier_veil_active_debuff)
