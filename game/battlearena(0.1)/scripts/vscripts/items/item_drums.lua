...
LinkLuaModifier("modifier_imba_drums", "items/item_drums", LUA_MODIFIER_MOTION_NONE, modifier_imba_drums)
LinkLuaModifier("modifier_imba_drums_aura", "items/item_drums", LUA_MODIFIER_MOTION_NONE, modifier_imba_drums_aura)
LinkLuaModifier("modifier_imba_drums_aura_effect", "items/item_drums", LUA_MODIFIER_MOTION_NONE, modifier_imba_drums_aura_effect)
LinkLuaModifier("modifier_imba_drums_active", "items/item_drums", LUA_MODIFIER_MOTION_NONE, modifier_imba_drums_active)
