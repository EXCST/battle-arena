...
LinkLuaModifier( "modifier_magnus_skewer_lua", "heroes/magnataur/modifier_magnus_skewer_lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_magnus_skewer_lua_debuff", "heroes/magnataur/modifier_magnus_skewer_lua_debuff", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_magnus_skewer_lua_slow", "heroes/magnataur/modifier_magnus_skewer_lua_slow", LUA_MODIFIER_MOTION_NONE )
