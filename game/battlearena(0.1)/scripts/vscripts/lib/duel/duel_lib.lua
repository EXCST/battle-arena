...
local DUEL_TRIGGER_NAME = "trigger_arena_zone"
...
function DuelLibrary:_MoveToDuel( unit, point )
	...
	-- Обновление всех способностей и предметов героя
...
function DuelLibrary:StartDuel(radiant_heroes, dire_heroes, hero_count, onDuelEnd)
	print("DuelLibrary:StartDuel start")
	...
	print("DuelLibrary:StartDuel end")
end
